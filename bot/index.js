...
const КЛАССИФИКАТОР_ПРОМТ = `Ты классифицируешь сообщения пользователя в систему персональной ОС жизни.

ТИПЫ (выбери ОДИН):
- task          — действие которое ПОЛЬЗОВАТЕЛЬ должен сделать сам
- waiting       — пользователь ЖДЁТ что-то от другого человека
- idea          — мысль/идея для будущего, не задача
...
3. Слова важности/срочности в task мапятся в quadrant:
   • «важно срочно» / «срочно важно»     → quadrant = "do"
   • «важно не срочно» / просто «важно»  → quadrant = "schedule"
   • «не важно срочно» / «делегировать»  → quadrant = "delegate"
   • «не важно не срочно» / «забить»     → quadrant = "eliminate"
...
→ {"тип":"task","извлечено":{"quadrant":"do","text":"Созвон с Димой — определиться с планом блога","time":"завтра 14:00","cat":"Бизнес"}}
