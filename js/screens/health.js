...
import { onWorkoutLogged, onNutritionUpdated } from '../gamification.js?v=62';
import { TG } from '../telegram.js?v=62';
import { PLAN_GOAL, STAGES, DAY_KEYS, DAY_LABELS, stageForWeek, planState, PLAN_WEEKS } from '../data/trainingPlan.js?v=62';
