...
import { injectUI, checkAchievements, onQuestCompleted, applyDebuffMode } from './gamification.js?v=41';
import { TG } from './telegram.js?v=41';
import { renderDash }         from './screens/dash.js?v=41';
import { renderTasks }        from './screens/tasks.js?v=41';
import { renderHealth }       from './screens/health.js?v=41';
import { renderProjects }     from './screens/projects.js?v=41';
import { renderPeople }       from './screens/people.js?v=41';
import { renderContent }      from './screens/content.js?v=41';
import { renderAchievements } from './screens/achievements.js?v=41';
import { renderOnboarding }   from './screens/onboarding.js?v=41';
import { renderAnalytics }    from './screens/analytics.js?v=41';
import * as Sync              from './supabaseSync.js?v=41';
import { openVoiceCapture }  from './voiceCapture.js?v=41';
