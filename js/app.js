...
import { injectUI, checkAchievements, onQuestCompleted, applyDebuffMode } from './gamification.js?v=84';
import { TG } from './telegram.js?v=84';
import { renderDash }         from './screens/dash.js?v=84';
import { renderTasks }        from './screens/tasks.js?v=84';
import { renderHealth }       from './screens/health.js?v=84';
import { renderProjects }     from './screens/projects.js?v=84';
import { renderPeople }       from './screens/people.js?v=84';
import { renderFinance }      from './screens/finance.js?v=84';
import { renderContent }      from './screens/content.js?v=84';
import { renderAchievements } from './screens/achievements.js?v=84';
import { renderOnboarding }   from './screens/onboarding.js?v=84';
import { renderAnalytics }    from './screens/analytics.js?v=84';
import * as Sync              from './supabaseSync.js?v=84';
import { openVoiceCapture }  from './voiceCapture.js?v=84';
