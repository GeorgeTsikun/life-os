...
import { injectUI, checkAchievements, onQuestCompleted, applyDebuffMode } from './gamification.js?v=73';
import { TG } from './telegram.js?v=73';
import { renderDash }         from './screens/dash.js?v=73';
import { renderTasks }        from './screens/tasks.js?v=73';
import { renderHealth }       from './screens/health.js?v=73';
import { renderProjects }     from './screens/projects.js?v=73';
import { renderPeople }       from './screens/people.js?v=73';
import { renderFinance }      from './screens/finance.js?v=73';
import { renderContent }      from './screens/content.js?v=73';
import { renderAchievements } from './screens/achievements.js?v=73';
import { renderOnboarding }   from './screens/onboarding.js?v=73';
import { renderAnalytics }    from './screens/analytics.js?v=73';
import * as Sync              from './supabaseSync.js?v=73';
import { openVoiceCapture }  from './voiceCapture.js?v=73';
