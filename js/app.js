...
import { injectUI, checkAchievements, onQuestCompleted, applyDebuffMode } from './gamification.js?v=31';
import { TG } from './telegram.js?v=31';
import { renderDash }         from './screens/dash.js?v=31';
import { renderTasks }        from './screens/tasks.js?v=31';
import { renderHealth }       from './screens/health.js?v=31';
import { renderProjects }     from './screens/projects.js?v=31';
import { renderPeople }       from './screens/people.js?v=31';
import { renderContent }      from './screens/content.js?v=31';
import { renderAchievements } from './screens/achievements.js?v=31';
import { renderOnboarding }   from './screens/onboarding.js?v=31';
import { renderAnalytics }    from './screens/analytics.js?v=31';
import * as Sync              from './supabaseSync.js?v=31';
import { openVoiceCapture }  from './voiceCapture.js?v=31';
